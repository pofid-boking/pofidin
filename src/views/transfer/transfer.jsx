    ...
    render() {
        ...
        return <div>
            <div className='coin'>
                <WingBlank>
                    <div className='title'>
                        <div className='left'><strong className="text-primary">{cy}</strong></div>
                        <div className='right text-primary'>
                            {amount}
                        </div>
                    </div>
            ...
            <div className='address'>
                <WingBlank>
                    <div className='title'>
                        <div className='left text-primary'>{lang.e().page.txTransfer.address}</div>
                        <div className='right text-primary'>
                        </div>
                    </div>
                    <div className='content'>
                        ...
                        <Icon type="iconAddressbook-" className="transfer-address text-primary" onClick={() => {
            ...
            <WhiteSpace size="lg"/>
            <div className='fee text-primary'>
                <WingBlank>
                    <div className='title'>
            ...
            <div className="btn-bottom">
                <Button type="primary" className="text-dark" disabled={this.state.confirming} onClick={()=>{this.submit()}} >{lang.e().button.next}</Button>
