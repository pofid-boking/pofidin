        ...
        return <div style={{height:document.documentElement.clientHeight}}>
            ...
            <WingBlank size="lg">
                <div style={{textAlign: "center"}}>
                    <Icon type="iconanquan" style={{width: '48px', height: '48px'}} className="text-primary"/>
                    <h2 className="text-primary">{lang.e().page.create.step4.title}</h2>
                    <p className="text-primary" onClick={()=>this.done()}>{lang.e().page.create.step4.skip}</p>
                    <p className="text-second">{lang.e().page.create.step4.d1}</p>
                    {
